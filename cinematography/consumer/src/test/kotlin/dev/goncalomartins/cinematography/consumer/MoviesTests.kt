package dev.goncalomartins.cinematography.consumer
...
import dev.goncalomartins.cinematography.consumer.util.TestUtils
...
class MoviesTests {
    ...
    fun testMovieCreation() {
        ...
        val createPersonPayload = JsonObject(
            String.format(
                testUtils.readFileAsString(PeopleTests.CREATE_PERSON_FILENAME),
