package dev.goncalomartins.knowledgebase.consumer.util

import dev.goncalomartins.knowledgebase.consumer.consumer.PeopleConsumerTest
...
class TestUtils {
    ...
    fun readFileAsString(file: String): String {
        val resource: InputStream = PeopleConsumerTest::class.java.classLoader.getResourceAsStream(file)!!
